...
public class TestCircle2D {
	...
	public static void main(String[] args) {
		//Create a circle
		Circle2D c1 = new Circle2D(2, 5, 5);
		System.out.printf("The are of c1 is %6.2f and its perimeter is %6.2f\n" , c1.getArea(), c1.getPerimeter());
		...
		System.out.println("C1 overlaps C3?: " + c1.contains(new Circle2D(3, 5, 2.3)));
	}
